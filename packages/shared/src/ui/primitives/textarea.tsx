...
const textareaVariants = cva(
  [
    'flex w-full min-w-0 resize-y rounded-md border bg-surface-input px-3 py-2',
  ...
  ],
  {
    variants: {
      size: {
        compact: 'min-h-24 text-sm leading-[22px]',
        standard: 'min-h-36 text-sm leading-[22px]',
        large: 'min-h-60 text-sm leading-[22px]',
      },
      mono: {
