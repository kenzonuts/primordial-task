...
export const createAppRouteRegistry = (): InMemoryRouteRegistry => {
  ...
  const routes = [
    ...
    { id: 'notes', path: ROUTES.notes, title: 'Notes' },
    { id: 'notes-create', path: `${ROUTES.notes}/new`, title: 'Create Note' },
    { id: 'notes-templates', path: `${ROUTES.notes}/templates`, title: 'Templates' },
    { id: 'notes-trash', path: `${ROUTES.notes}/trash`, title: 'Trash' },
    { id: 'note-detail', path: `${ROUTES.notes}/:id`, title: 'Note' },
    { id: 'note-history', path: `${ROUTES.notes}/:id/history`, title: 'Note History' },
    { id: 'docs', path: ROUTES.docs, title: 'Documentation' },
    { id: 'doc-detail', path: `${ROUTES.docs}/:id`, title: 'Documentation Page' },
    { id: 'analytics', path: ROUTES.analytics, title: 'Analytics' },
    { id: 'analytics-overview', path: `${ROUTES.analytics}/overview`, title: 'Analytics Overview' },
    {
      id: 'analytics-workspace',
      path: `${ROUTES.analytics}/workspace`,
      title: 'Workspace Analytics',
    },
    { id: 'analytics-projects', path: `${ROUTES.analytics}/projects`, title: 'Project Analytics' },
    { id: 'analytics-tasks', path: `${ROUTES.analytics}/tasks`, title: 'Task Analytics' },
    { id: 'analytics-team', path: `${ROUTES.analytics}/team`, title: 'Team Analytics' },
    { id: 'analytics-time', path: `${ROUTES.analytics}/time`, title: 'Time Analytics' },
    { id: 'analytics-reports', path: `${ROUTES.analytics}/reports`, title: 'Analytics Reports' },
    {
      id: 'analytics-report-detail',
      path: `${ROUTES.analytics}/reports/:id`,
